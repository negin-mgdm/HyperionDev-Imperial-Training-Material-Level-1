...
# i.e. - getTime() - it makes sense that there is no need for input parameters. 
# Unless you had a more complex function like get_time(timezone) which returned 
# the time for a specific timezone the user provided!
...
# Think of it as copying in the values from the inputted parameter values when 
...
# tasks with hundreds of lines of code.
# i.e. break up a complicated function into many simpler functions so that it is 
# easier to understand the function's role and find errors!
...
num = 10
# This loop rRuns 10 times, each time, 1 is added to the value of 10. 
...
# Here, we assigned a value to the global variable j inside the function, 
# which then created a new local variable. That is why j inside the function equals 7,
